                ...
                <tbody className="bg-white divide-y divide-gray-200 text-black">
                  {logs.map((log, idx) => (
                    <tr key={idx} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-black">
                        <span className="inline-flex items-center px-2 py-1 rounded-full text-xs bg-gray-100 text-gray-800">{log.agent}</span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-black">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm">
                        <span className={`px-2 py-1 rounded text-xs ${
                          log.level === 'error' ? 'bg-red-100 text-red-800' : log.level === 'warn' ? 'bg-yellow-100 text-yellow-800' : 'bg-green-100 text-green-800'
                        }`}>
